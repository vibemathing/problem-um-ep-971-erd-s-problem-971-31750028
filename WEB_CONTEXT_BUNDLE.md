...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-971-erd-s-problem-971-31750028-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-971"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-971-erd-s-problem-971-31750028-v1",
      "problem_contract_sha256": "794d07ad46ce3f26f6d257f0034b31e19485de96875bb1a11a64b9290bd22649",
      "problem_id": "problem:um-ep-971-erd-s-problem-971-31750028",
      "route_id": "route:um-ep-971-erd-s-problem-971-31750028-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-971-erd-s-problem-971-31750028-source-fidelity-01",
      "graph_id": "graph:um-ep-971-erd-s-problem-971-31750028-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-971-erd-s-problem-971-31750028-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-971-erd-s-problem-971-31750028-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $p(a,d)$ be the least prime congruent to $a\\pmod{d}$. Does there exist a constant $c>0$ such that, for all large $d$, $ p(a,d) > (1+c)\\phi(d)\\log d $ for $\\gg \\phi(d)$ many values of $a$?"
          },
          "statement_sha256": "0d533a1c7fe5ddc66829f6f7965f2c4a52de5db27b694ad11a15e42b75ac556d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-971-erd-s-problem-971-31750028-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-971-erd-s-problem-971-31750028-root",
      "route_id": "route:um-ep-971-erd-s-problem-971-31750028-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-971-f39819f0ada5",
        "url": "https://www.unsolvedmath.com/problems/EP-971"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
